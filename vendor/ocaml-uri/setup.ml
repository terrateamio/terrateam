...
(* OASIS_START *)
(* DO NOT EDIT (digest: de86d95f4c234bf3b57ad84983808a08) *)
(*
...
(* # 21 "/Users/avsm/.opam/4.00.1+short-types/build/oasis-mirage.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "M∞Ê\133‚~‰n‘Ú±\018nÏ\158K";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
