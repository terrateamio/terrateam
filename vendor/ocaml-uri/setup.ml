...
(* OASIS_START *)
(* DO NOT EDIT (digest: c65c23d260e96313d7fd7d7083939e02) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.02.2");
          ...
          homepage = Some "https://github.com/mirage/ocaml-uri";
          synopsis = "RFC3986 URI parsing library";
          description =
            Some
              [
                 OASISText.Para
                   "Uniform Resource Identifier (URI) parsing and encoding. This is pure OCaml code."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\149îÙ{\128%J\131½\026í9¹\019¦f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
