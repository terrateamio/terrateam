...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69137d4ffe6fe53cbe4888dde3eb34c6) *)
(*
...
let setup_t =
  {
     ...
     doc = [("uri", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("uri", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test_runner",
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\145\016\136Á³<©r­\158­\132\012Öú\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
