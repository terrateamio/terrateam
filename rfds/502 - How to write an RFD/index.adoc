...
https://github.com/stategraph/stategraph/issues[Terrateam] repository.
...
that we can understand why a decision wasn't taken.  The `abandoned` state was
...
Either a `committed` or `abandoned` states is necessary for merging.
