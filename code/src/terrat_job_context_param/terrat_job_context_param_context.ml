type t =
  ...
  | Setup of Terrat_job_context_param_setup.t
[@@deriving show, eq]
  ...
  Json_schema.one_of
    (let open CCResult in
     [
       ...
       (fun v -> map (fun v -> Setup v) (Terrat_job_context_param_setup.of_yojson v));
     ])
...
let to_yojson = function
  ...
  | Setup v -> Terrat_job_context_param_setup.to_yojson v
