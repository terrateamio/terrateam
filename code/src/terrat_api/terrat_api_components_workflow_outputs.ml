module Items =
  struct
    type t =
      | Workflow_output_apply of
      Terrat_api_components_workflow_output_apply.t 
    ...
    let of_yojson =
      Json_schema.one_of
        (let open CCResult in
           [(fun v ->
               map (fun v -> Workflow_output_apply v)
           ...
           (fun v ->
              map (fun v -> Workflow_output_init v)
           ...
           (fun v ->
              map (fun v -> Workflow_output_plan v)
    ...
    let to_yojson =
      function
      | Workflow_output_apply v ->
          Terrat_api_components_workflow_output_apply.to_yojson v
      | Workflow_output_env v ->
          Terrat_api_components_workflow_output_env.to_yojson v
      | Workflow_output_init v ->
          Terrat_api_components_workflow_output_init.to_yojson v
      | Workflow_output_oidc v ->
          Terrat_api_components_workflow_output_oidc.to_yojson v
      | Workflow_output_plan v ->
          Terrat_api_components_workflow_output_plan.to_yojson v
