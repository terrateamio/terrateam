...
delete_pull_requests_map as (
    ...
    using gitlab_installation_repositories as gir
    where gitlab_pull_requests_map.repository_id = gir.id
        and gir.id = $repo_id
        and gir.installation_id = $installation_id
),
delete_pull_requests as (
    ...
    using gitlab_installation_repositories as gir
    where gitlab_pull_requests.repository = gir.id
        and gir.id = $repo_id
        and gir.installation_id = $installation_id
),
delete_repositories_map as (
    ...
    using gitlab_installation_repositories as gir
    where gitlab_repositories_map.repository_id = gir.id
        and gir.id = $repo_id
        and gir.installation_id = $installation_id
)
