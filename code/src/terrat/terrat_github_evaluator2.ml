...
module S = struct
  ...
  let make_commit_check ?run_id ~description ~title ~status repo =
    let details_url =
      match run_id with
      | Some run_id ->
  ...
  module Event = struct
    ...
    module Initiate = struct
      ...
      let fetch_dirspaces' client repo ref_ =
        let run =
          let open Abbs_future_combinators.Infix_result_monad in
          Abbs_future_combinators.Infix_result_app.(
      ...
      let fetch_dirspaces client repo base_ref ref_ =
        Abbs_future_combinators.Infix_result_app.(
          ...
          <$> fetch_dirspaces' client repo base_ref
          <*> fetch_dirspaces' client repo ref_)
      ...
      let of_work_manifest t work_manifest =
        ...
        | {
            ...
            >>= fun client ->
            fetch_dirspaces client repo base_ref ref_
