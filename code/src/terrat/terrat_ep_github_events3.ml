  ...
  | Gw.Pull_request_event.Pull_request_opened
      ...
      let repo =
        Terrat_github_evaluator3.S.Repo.make
          ...
          ()
      in
      Terrat_github_evaluator3.run_pull_request_open
  ...
  | Gw.Pull_request_event.Pull_request_synchronize
      ...
      let repo =
        Terrat_github_evaluator3.S.Repo.make
          ...
          ()
      in
      Terrat_github_evaluator3.run_pull_request_sync
        ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
        ~account
        ~user
        ~repo
  ...
  | Gw.Pull_request_event.Pull_request_ready_for_review
      ...
      let repo =
        Terrat_github_evaluator3.S.Repo.make
          ...
          ()
      in
      Terrat_github_evaluator3.run_pull_request_ready_for_review
        ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
        ~account
        ~user
        ~repo
  ...
  | Gw.Pull_request_event.Pull_request_closed
      ...
      let repo =
        Terrat_github_evaluator3.S.Repo.make
          ...
          ()
      in
      Terrat_github_evaluator3.run_pull_request_close
        ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
        ~account
        ~user
        ~repo
      ...
      | Ok comment ->
          ...
          let repo =
            Terrat_github_evaluator3.S.Repo.make
              ...
              ()
          in
          Terrat_github_evaluator3.run_pull_request_comment
            ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
            ~account
            ~user
            ~comment
...
let process_workflow_job request_id config storage event =
  ...
  | Gw.Workflow_job_event.
      ...
      | Some work_manifest_id ->
          Terrat_github_evaluator3.work_manifest_failure
            ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
            work_manifest_id
      | None ->
          Logs.info (fun m ->
...
let process_push_event request_id config storage event =
  ...
  | Some installation_lite when CCString.equal ref_ default_ref ->
      ...
      Terrat_github_evaluator3.run_push
        ~ctx:(Terrat_evaluator3.Ctx.make ~request_id ~config ~storage ())
        ~account
        ~user
        ~repo
