...
create table if not exists github_pull_request_summary_elements(
    -- the original id github gave us
    comment_id bigint not null,
    dir text not null,
...
create index if not exists github_pull_request_summary_comment_idx on github_pull_request_summary_comments(comment_id);
