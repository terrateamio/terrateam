...
module Depends_on = Terrat_repo_config_depends_on
module Depends_on_object = Terrat_repo_config_depends_on_object
module Depends_on_tag_query = Terrat_repo_config_depends_on_tag_query
...
module Hook_op_run_format = Terrat_repo_config_hook_op_run_format
module Hook_op_run_format_obj = Terrat_repo_config_hook_op_run_format_obj
module Hook_op_run_format_str = Terrat_repo_config_hook_op_run_format_str
...
module Stack_nested_config = Terrat_repo_config_stack_nested_config
module Stack_rules = Terrat_repo_config_stack_rules
