...
module Task_completion_status = struct
  type t = Yojson.Safe.t [@@deriving yojson { strict = false; meta = true }, show, eq]
end
...
type t = {
  ...
  downvotes : int option; [@default None]
  ...
  squash_on_merge : bool option; [@default None]
  state : string;
  subscribed : bool option; [@default None]
  target_branch : string;
  target_project_id : int option; [@default None]
  task_completion_status : Task_completion_status.t option; [@default None]
  ...
  upvotes : int option; [@default None]
  user : User.t;
  user_notes_count : int option; [@default None]
