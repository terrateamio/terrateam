  ...
  module Service = struct
    ...
    let start config vcs_config storage exec =
      ...
      Abb.Future.Infix_app.(
        (fun drift plan_cleanup repo_config_cleanup -> (drift, plan_cleanup, repo_config_cleanup))
      ...
      Abb.Future.return (Ok { config; drift; plan_cleanup; repo_config_cleanup; storage; exec })
