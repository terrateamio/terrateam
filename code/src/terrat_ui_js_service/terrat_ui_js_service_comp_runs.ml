...
module Make (Vcs : Terrat_ui_js_service_vcs.S) = struct
  ...
  let render_dirspace query dirspace state =
    ...
    let { State.server_config; _ } = app_state.State.v in
                      ...
                      ~at:
                        At.
                          [
                            ...
                            href
                              (Jstr.v (Printf.sprintf "%s/%s/%s" web_base_url repo_owner repo_name));
                          ]
      ...
      (Brtl_js2.Output.const
         [
           ...
           div
             ...
             [
               a
                 ~at:At.[ href (Jstr.v (consumed_path ^ "/" ^ work_manifest_id)) ]
                 [ txt' "Details" ];
             ];
         ])
          ...
          [
            ul
              [
                  ...
                  [
                    ...
                    txt'
                      " - Match those operations performed between the specified dates.  The query \
                       is inclusive for the first date an exclusive for the second date.  The \
                       first or second date may be omitted.";
                  ];
                li
                  [
                ...
                li
                  [
                    code [ txt' "environment:" ];
                    txt' " - Match runs with no environment specified.";
                  ];
                li
                  [
                    code [ txt' "sort:asc" ];
              ...
              [
                ...
                li
                  [
                    ...
                    txt'
                      " - All pull request operations that were performed on the 'infra/s3' and \
                       the 'infra/iam' directories and sort the results by oldest first.";
                  ];
              ];
          ];
      ]
  ...
  let comp state =
    ...
    let module Page = Brtl_js2_page.Make (struct
      ...
      let format_err =
        ...
        | (`Not_found | `Conversion_err _ | `Missing_response _ | `Forbidden | `Bad_request _) as
          err -> El.[ txt' ("Unknown error: " ^ show_fetch_err err) ]
