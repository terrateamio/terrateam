    ...
    let btn =
      Brtl_js2.Kit.Ui.Button.v'
        ...
        ~action:(fun () ->
          ...
          >>= fun _ ->
          let module Notice = Terrat_ui_js_service_comp_notifications.Notice in
          notify @@ Notice.make ~msg:(Notice.msg_success Brtl_js2.Brr.El.[ txt' "Copied" ]) ();
                 ...
                 div
                   ...
                   [
                     ...
                     span
                       [
                         txt'
                           " Setup your cloud providers.  Terrateam needs permission to access \
                            your cloud provider in order to make changes with the Terraform CLI. ";
                       ];
                     ul
                               ...
                               ~at:
                                 At.
                                   [
                                     href
                                       (Jstr.v
                                          "https://terrateam.io/docs/cloud-provider-setup/azure");
                                     v (Jstr.v "target") (Jstr.v "_blank");
                                   ]
                               [ txt' "Azure" ];
                           ];
                               ...
                               ~at:
                                 At.
                                   [
                                     href
                                       (Jstr.v
                                          "https://terrateam.io/docs/cloud-provider-setup/other");
                                     v (Jstr.v "target") (Jstr.v "_blank");
                                   ]
                               [ txt' "Other" ];
                           ];
