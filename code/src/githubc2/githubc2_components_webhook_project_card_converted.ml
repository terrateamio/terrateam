module Primary = struct
  module Action = struct
    ...
    type t = ([ `Converted ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
  ...
  module Changes = struct
    module Primary = struct
      ...
      type t = { note : Note.t } [@@deriving yojson { strict = false; meta = true }, show, eq]
    end
  ...
  type t = {
    ...
    project_card : Githubc2_components_webhooks_project_card.t;
