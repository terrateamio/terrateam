module Primary = struct
  module Action = struct
    ...
    type t = ([ `Transferred ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
    [@@deriving yojson { strict = false; meta = true }, show, eq]
  end

  module Changes = struct
    module Primary = struct
      module New_issue = struct
        module Primary = struct
                ...
                module Primary = struct
                  ...
                  type t = {
                    ...
                    organization_self_hosted_runners : Organization_self_hosted_runners.t option;
                        [@default None]
                    organization_user_blocking : Organization_user_blocking.t option;
                        [@default None]
      ...
      type t = {
        new_issue : New_issue.t;
        new_repository : New_repository.t;
      }
      [@@deriving yojson { strict = false; meta = true }, show, eq]
    end
