module Primary = struct
  module Action = struct
    ...
    let t_to_yojson = function
      | `Demilestoned -> `String "demilestoned"

    type t = ([ `Demilestoned ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
  ...
  type t = {
    ...
    issue : Issue_.t;
    milestone : Githubc2_components_webhooks_milestone.t option; [@default None]
