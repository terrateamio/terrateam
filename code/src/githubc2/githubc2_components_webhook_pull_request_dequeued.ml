module Primary = struct
  module Action = struct
    ...
    type t = ([ `Dequeued ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
  ...
  module Reason = struct
    let t_of_yojson = function
      | `String "ALREADY_MERGED" -> Ok `ALREADY_MERGED
      | `String "BRANCH_PROTECTIONS" -> Ok `BRANCH_PROTECTIONS
      | `String "CI_FAILURE" -> Ok `CI_FAILURE
      | `String "CI_TIMEOUT" -> Ok `CI_TIMEOUT
      | `String "GIT_TREE_INVALID" -> Ok `GIT_TREE_INVALID
      | `String "INVALID_MERGE_COMMIT" -> Ok `INVALID_MERGE_COMMIT
      | `String "MANUAL" -> Ok `MANUAL
      | `String "MERGE" -> Ok `MERGE
      | `String "MERGE_CONFLICT" -> Ok `MERGE_CONFLICT
      | `String "QUEUE_CLEARED" -> Ok `QUEUE_CLEARED
      | `String "ROLL_BACK" -> Ok `ROLL_BACK
      | `String "UNKNOWN_REMOVAL_REASON" -> Ok `UNKNOWN_REMOVAL_REASON
      | json -> Error ("Unknown value: " ^ Yojson.Safe.pretty_to_string json)

    let t_to_yojson = function
      | `ALREADY_MERGED -> `String "ALREADY_MERGED"
      | `BRANCH_PROTECTIONS -> `String "BRANCH_PROTECTIONS"
      | `CI_FAILURE -> `String "CI_FAILURE"
      | `CI_TIMEOUT -> `String "CI_TIMEOUT"
      | `GIT_TREE_INVALID -> `String "GIT_TREE_INVALID"
      | `INVALID_MERGE_COMMIT -> `String "INVALID_MERGE_COMMIT"
      | `MANUAL -> `String "MANUAL"
      | `MERGE -> `String "MERGE"
      | `MERGE_CONFLICT -> `String "MERGE_CONFLICT"
      | `QUEUE_CLEARED -> `String "QUEUE_CLEARED"
      | `ROLL_BACK -> `String "ROLL_BACK"
      | `UNKNOWN_REMOVAL_REASON -> `String "UNKNOWN_REMOVAL_REASON"
