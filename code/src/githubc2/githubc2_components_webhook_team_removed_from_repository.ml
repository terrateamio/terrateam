module Primary = struct
  module Action = struct
    let t_of_yojson = function
      | `String "removed_from_repository" -> Ok `Removed_from_repository
      | json -> Error ("Unknown value: " ^ Yojson.Safe.pretty_to_string json)

    let t_to_yojson = function
      | `Removed_from_repository -> `String "removed_from_repository"

    type t = ([ `Removed_from_repository ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
