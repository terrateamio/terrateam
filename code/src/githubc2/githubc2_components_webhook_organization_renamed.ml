module Primary = struct
  module Action = struct
    ...
    type t = ([ `Renamed ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
  ...
  module Changes = struct
    module Primary = struct
      ...
      type t = { login : Login.t option [@default None] }
      [@@deriving yojson { strict = false; meta = true }, show, eq]
    end
  ...
  type t = {
    ...
    membership : Githubc2_components_webhooks_membership.t option; [@default None]
