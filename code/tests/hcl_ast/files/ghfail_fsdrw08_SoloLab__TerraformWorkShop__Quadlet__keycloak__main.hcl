...
#   for_each = toset([
#     "./attachments/keycloak.consul.hcl",
#     "./attachments-postgresql/keycloak-pg.consul.hcl",
#   ])
...
#   ]
#   for_each = toset([
#     "./attachments/keycloak.traefik.yaml",
#     "./attachments-keycloak-login/keycloak-login.traefik.yaml",
#   ])
