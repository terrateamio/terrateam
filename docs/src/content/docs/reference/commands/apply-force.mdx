...
In addition to bypassing apply requirements, `apply-force` also bypasses [Gatekeeper](/governance/gatekeeper/) gates: gated steps are skipped and no gate approval is requested.
