...
<CardGrid>
  <Card title="Work Manifests" icon="document">
    Manage work manifest execution, plans, and results for Terraform/OpenTofu operations.

    [View Endpoints →](/reference/api/work-manifests)
  </Card>
...
- Report API issues on [GitHub](https://github.com/terrateamio/terrateam/issues)
- Join the [Terrateam community](https://terrateam.io/discord) for discussion
