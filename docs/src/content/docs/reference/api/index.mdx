...
<CardGrid>
  ...
  <Card title="API Users" icon="seti:lock">
    Create and manage System API Users for programmatic access to reporting data and drift operations.

    [View Endpoints →](/reference/api/api-users)
  </Card>
  ...
  <Card title="Drift Detection" icon="seti:clock">
    Trigger on-demand drift detection for an installation.

    [View Endpoints →](/reference/api/drift)
  </Card>
