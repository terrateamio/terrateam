...
<CardGrid>
  ...
  <Card title="CODEOWNERS Integration" icon="github">
    Automatic enforcement of repository CODEOWNERS files for infrastructure approvals, ensuring the right teams review changes to their owned resources.
  </Card>
