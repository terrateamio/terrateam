...
- Terrateam server [ghcr.io/terrateamio/terrateam:v1](https://github.com/orgs/terrateamio/packages/container/package/terrateam)
...
Terrateam Self-Hosted provides the flexibility to deploy all of Terrateam to your
own infrastructure giving you full control of your data.

### How Much Does Terrateam Self-Hosted Cost?
Terrateam Self-Hosted is free for evaluation expiring after 30
days. [Reach out for an enterprise subscription ](mailto:sales@terrateam.io)
