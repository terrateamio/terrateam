...
- **A GitHub account** to fork our demo repository
...
You've successfully completed your first Terrateam deployment using our demo repository! This demonstrates the core GitOps workflow that Terrateam enables:
