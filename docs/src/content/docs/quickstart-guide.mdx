...
#### Step 1. [Install the Terrateam GitHub Application](https://github.com/apps/terrateam-action)
   ...
   * [Click here to install the Terrateam GitHub application](https://github.com/apps/terrateam-action)
