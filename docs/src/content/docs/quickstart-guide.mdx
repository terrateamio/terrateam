...
The [`null_resource`](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) in Terraform allows you to run provisioners without creating real infrastructure. It’s perfect for testing workflows.
:::
