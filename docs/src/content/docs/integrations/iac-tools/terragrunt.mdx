...
To use Terragrunt with Terrateam, you need to configure Terrateam to use the Terragrunt CLI instead of the default Terraform CLI. You can do this by specifying the [engine](/reference/configuration/engine) in your Terrateam configuration file (`.terrateam/config.yml`).
...
![Terragrunt Pull Request Files Changed](/src/assets/terragrunt-pull-request-files-changed.png)
![Terragrunt Plan Output](/src/assets/terragrunt-plan-output.png)
