...
1. ### Navigate to CloudFormation
   ...
   ![Terrateam Setup CloudFormation Create Stack](/src/assets/cloudformation-create-stack.png)
...
2. ### Specify Stack Details
   ...
   ![Terrateam Setup CloudFormation Stack Details](/src/assets/cloudformation-stack-details.png)
...
3. ### Configure Stack Options
   ...
   ![Terrateam Setup CloudFormation Configure Stack Options](/src/assets/cloudformation-configure-stack-options.png)

4. ### Review and Create the Stack

   ![Terrateam Setup CloudFormation Review and Create](/src/assets/cloudformation-review-and-create.png)
