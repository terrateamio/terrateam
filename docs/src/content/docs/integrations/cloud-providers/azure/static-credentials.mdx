...
description: Configure Terrateam with Azure static credentials
---

import { Steps } from '@astrojs/starlight/components';

:::caution[Consider OIDC]
Static credentials require storing long-lived secrets in GitHub. For production environments, we recommend using [OIDC authentication](/integrations/cloud-providers/azure/oidc-setup) instead.
:::
