...
Terrateam is a powerful GitHub application that seamlessly integrates with your [Terraform](https://www.terraform.io/) workflow, enabling you to manage your infrastructure as code directly from your pull requests. This page explains the core concepts and inner workings of Terrateam.
