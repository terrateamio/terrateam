...
Check out our [Quickstart Guide](/getting-started/quickstart-guide) or explore [Terrateam key concepts](/getting-started/concepts) to deepen your understanding.
</Aside>
