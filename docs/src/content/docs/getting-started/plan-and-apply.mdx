...
| Pre-merge Workflow  |  Post-merge Workflow |
|---|---|
| - Greater safety and visibility. <br/> - More complex. <br/> - Recommended for critical infrastructure.  | - Simpler and faster. <br/>- Increased risk. <br/>- Suitable for less sensitive environments.  |
