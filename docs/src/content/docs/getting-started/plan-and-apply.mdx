...
4. Collaborate with your team to ensure the proposed changes are correct.
</Steps>
...
:::caution
If another PR is trying to apply changes to the same directory, it will be blocked until the current lock is released. This prevents conflicting changes from being applied simultaneously.
:::
