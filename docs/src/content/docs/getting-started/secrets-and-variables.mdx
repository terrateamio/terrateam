...
**Example: Referencing the secret in Terraform**
...
This will create an environment variable `TF_VAR_database_password` which Terraform can automatically map to a variable named `database_password`.
...
**Example use case:** Setting a dynamic environment variable based on the current Git branch:
