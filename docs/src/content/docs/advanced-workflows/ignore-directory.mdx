...
- Directories containing only documentation, static assets, or test code that doesn't directly affect infrastructure provisioning.
...
:::tip
You can use glob patterns to ignore groups of files, such as all Markdown files:
:::
