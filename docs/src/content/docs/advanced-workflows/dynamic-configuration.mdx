...
Running arbitrary scripts as part of your configuration builder introduces security risks. Scripts can access repository contents, secrets, and the environment. Only trusted users should be allowed to modify or approve config builder scripts. Always review scripts for malicious or unintended behavior before enabling.
:::
